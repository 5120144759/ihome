...
$(document).ready(function () {
    ...
    $.get('/house/area_facility/', function (data) {
        if (data.code == 200) {
            var area_list = template('area_script_id', {areas: data.areas});
    ...
    $.get('/house/hindex/', function (data) {
        if (data.code == 200) {
            ...
            var swiper_html_script = template('swiper_html_script', {ohouse: data.house_image});
            $('.swiper-wrapper').append(swiper_html_script)
